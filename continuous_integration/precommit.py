...
def main() -> int:
    ...
    if Step.DOCTEST in selects and Step.DOCTEST not in skips:
        ...
        for pth in (repo_root / "elvolantevirtual").glob("**/*.py"):
    ...
    if (
        ...
        print("Checking that elvolantevirtual/__init__.py and setup.py coincide...")
        exit_code = call_and_report(
            verb="check that elvolantevirtual/__init__.py and setup.py coincide",
            cmd=[
                sys.executable,
        ...
        print(
            "Skipped checking that elvolantevirtual/__init__.py and setup.py coincide."
        )
